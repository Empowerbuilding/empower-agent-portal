// Simple flat SVG icons — white, stroke-based, Discord-style
...
export function IconMicOff({ size = 16 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconPaperclip({ size = 18 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconSend({ size = 16 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
...
export function IconCalendarClock({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconClock({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconMessageCircle({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconUsers({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconDatabase({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconRender({ size = 16 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconFolder({ size = 15 }: { size?: number }) {
  return (
...
export function IconGallery({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export function IconDesignOS({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 20h9" />
...
export function IconHeartbeat({ size = 15 }: { size?: number }) {
  return (
    <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
